...
#include <offer/plugins/condenser_api/condenser_api.hpp>
...
using namespace offer::utilities;
...
{
   public:
      wallet_api( const wallet_data& initial_data, const offer::protocol::chain_id_type& _offer_chain_id, fc::api< remote_node_api > rapi );
      virtual ~wallet_api();
       ...
       *  'info' wallet command.
       *
       *  These accounts are created with combination of OFFER and delegated SP
       *
       *  @param creator The account creating the new account
       *  @param offer_fee The amount of the fee to be paid with OFFER
      ...
      /**
       * Transfer funds from one account to another. OFFER and BSD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 OFFER"
      ...
      /**
       * Transfer funds from one account to another using escrow. OFFER and BSD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       ...
       * @param offer_amount The amount of OFFER to transfer
       ...
       * @param offer_amount The amount of OFFER that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer OFFER into a coining fund represented by coining shares (COINS). COINS are required to coining
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * COINS are protected against dilution up until 90% of OFFER is coining.
       *
       * @param from The account the OFFER is coming from
       * @param to The account getting the COINS
       * @param amount The amount of OFFER to coin i.e. "100.00 OFFER"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as OFFER. i.e. "10.000000 COINS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the COINS are withdrawn from.
       * @param to   The account receiving either COINS or OFFER.
      ...
      /**
       *  This method will convert BSD to OFFER at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the OFFER:BSD market. The median price feed is used
       * to process conversion requests from BSD to OFFER.
       *
       ...
       *                       operations defined in `offer/chain/operations.hpp`
      ...
      /**
       * Gets the current order book for OFFER:BSD
       *
       ...
       *  @param amount_to_sell The amount of either BSD or OFFER you wish to sell
      ...
      /**
       * Vote on a comment to be paid OFFER
       *
...
FC_REFLECT( offer::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( offer::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( offer::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( offer::wallet::authority_type, (owner)(active)(posting) )

FC_API( offer::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( offer::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
