...
namespace offer { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert bsd to offer
    */
    ...
    *  1000 OFFER or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return offer_volume * bsd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(offer_volume,bsd_volume) * is_positive();
         }
         ...
         {
            return ( offer_volume > 0 && bsd_volume > 0 ) ? 1 : 0;
         }
   };
...
FC_REFLECT( offer::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::limit_order_object, offer::chain::limit_order_index )

FC_REFLECT( offer::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::feed_history_object, offer::chain::feed_history_index )

FC_REFLECT( offer::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::convert_request_object, offer::chain::convert_request_index )

FC_REFLECT( offer::chain::liquidity_reward_balance_object,
             (id)(owner)(offer_volume)(bsd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::liquidity_reward_balance_object, offer::chain::liquidity_reward_balance_index )

FC_REFLECT( offer::chain::withdraw_coining_route_object,
             (id)(from_account)(to_account)(percent)(auto_coin) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::withdraw_coining_route_object, offer::chain::withdraw_coining_route_index )

FC_REFLECT( offer::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::savings_withdraw_object, offer::chain::savings_withdraw_index )

FC_REFLECT( offer::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bsd_balance)(offer_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::escrow_object, offer::chain::escrow_index )

FC_REFLECT( offer::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::decline_voting_rights_request_object, offer::chain::decline_voting_rights_request_index )

FC_REFLECT( offer::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( offer::chain::reward_fund_object, offer::chain::reward_fund_index )
