...
#include <offer/protocol/schema_types.hpp>
#include <offer/chain/schema_types.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< offer::schema::abstract_schema > get_operation_schema() override
      {
         return offer::schema::get_schema_for_type< CustomOperationType >();
      }
};
