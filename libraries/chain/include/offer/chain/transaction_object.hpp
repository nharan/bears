...
FC_REFLECT( offer::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::transaction_object, offer::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<offer::chain::transaction_index>
   {
   public:
      typedef offer::chain::transaction_index IndexType;
      typedef typename offer::chain::transaction_object::t_packed_trx t_packed_trx;
