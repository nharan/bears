...
using offer::protocol::optional_automated_action;
...
FC_REFLECT( offer::chain::pending_optional_action_object,
            (id)(action) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::pending_optional_action_object, offer::chain::pending_optional_action_index )
