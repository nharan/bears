...
public:   
   ...
   asset               liquid;   /// 'balance' for OFFER
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_offer_balance' for pending OFFER
   asset               pending_coining_shares;  /// 'reward_coining_balance' for pending COINS
   asset               pending_coining_value;   /// 'reward_coining_offer' for pending COINS
...
FC_REFLECT( offer::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (coining)
...
FC_REFLECT( offer::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( offer::chain::account_regular_balance_object, offer::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( offer::chain::account_rewards_balance_object, offer::chain::account_rewards_balance_index )
