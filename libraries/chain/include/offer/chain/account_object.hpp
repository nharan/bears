...
#include <offer/chain/shared_authority.hpp>
...
namespace offer { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = OFFER_NULL_ACCOUNT;
         ...
         asset             balance = asset( 0, OFFER_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, OFFER_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  OFFER_MIN_COMPOUNDING_INTERVAL_SECONDS has past since bsd_last_interest_payment then
         ...
         asset             reward_offer_balance = asset( 0, OFFER_SYMBOL );
         asset             reward_coining_balance = asset( 0, COINS_SYMBOL );
         asset             reward_coining_offer = asset( 0, OFFER_SYMBOL );
         ...
         fc::array<share_type, OFFER_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( OFFER_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( offer::chain::account_object,
             ...
             (reward_offer_balance)(reward_bsd_balance)(reward_coining_balance)(reward_coining_offer)
...
CHAINBASE_SET_INDEX_TYPE( offer::chain::account_object, offer::chain::account_index )

FC_REFLECT( offer::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( offer::chain::account_authority_object, offer::chain::account_authority_index )

FC_REFLECT( offer::chain::coining_delegation_object,
            (id)(delegator)(delegatee)(coining_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::coining_delegation_object, offer::chain::coining_delegation_index )

FC_REFLECT( offer::chain::coining_delegation_expiration_object,
            (id)(delegator)(coining_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::coining_delegation_expiration_object, offer::chain::coining_delegation_expiration_index )

FC_REFLECT( offer::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( offer::chain::owner_authority_history_object, offer::chain::owner_authority_history_index )

FC_REFLECT( offer::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( offer::chain::account_recovery_request_object, offer::chain::account_recovery_request_index )

FC_REFLECT( offer::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( offer::chain::change_recovery_account_request_object, offer::chain::change_recovery_account_request_index )
