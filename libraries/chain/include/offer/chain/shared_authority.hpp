...
namespace offer { namespace chain {
   ...
   using offer::protocol::weight_type;
...
FC_REFLECT_TYPENAME( offer::chain::shared_authority::account_authority_map)
FC_REFLECT( offer::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
