...
#include <offer/chain/util/rd_dynamics.hpp>
...
namespace offer { namespace chain {
   ...
   using offer::protocol::digest_type;
   using offer::protocol::public_key_type;
   using offer::protocol::version;
   using offer::protocol::hardfork_version;
   using offer::protocol::price;
   using offer::protocol::asset;
   using offer::protocol::asset_symbol_type;
   using offer::chain::util::rd_dynamics_params;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( OFFER_MIN_ACCOUNT_CREATION_FEE, OFFER_SYMBOL );
       ...
       * Scaled so that OFFER_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << OFFER_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Offer blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, OFFER_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( offer::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( offer::chain::chain_properties,
...
FC_REFLECT( offer::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( offer::chain::witness_object, offer::chain::witness_index )

FC_REFLECT( offer::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( offer::chain::witness_vote_object, offer::chain::witness_vote_index )

FC_REFLECT( offer::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( offer::chain::witness_schedule_object, offer::chain::witness_schedule_index )
