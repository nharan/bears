...
#define OFFER_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
OFFER_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define OFFER_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define OFFER_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define OFFER_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
OFFER_DECLARE_SCHEMA_CLASS( false, false )
OFFER_DECLARE_SCHEMA_CLASS(  true, false )
OFFER_DECLARE_SCHEMA_CLASS(  true,  true )
