...
#define OFFER_WEBSERVER_PLUGIN_NAME "webserver"

namespace offer { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = OFFER_WEBSERVER_PLUGIN_NAME; return name; }
