...
using offer::plugins::statsd::statsd_plugin;
...
if( offer::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   offer::plugins::statsd::util::get_statsd().increment( \
...
if( offer::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   offer::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( offer::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   offer::plugins::statsd::util::get_statsd().count(     \
...
if( offer::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   offer::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< offer::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( offer::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = offer::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, offer::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( offer::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   offer::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      offer::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
