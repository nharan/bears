...
#define OFFER_STATSD_PLUGIN_NAME "statsd"

namespace offer { namespace plugins { namespace statsd {
...
class statsd_plugin : public appbase::plugin< statsd_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = OFFER_STATSD_PLUGIN_NAME; return name; }
