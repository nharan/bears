...
#ifndef OFFER_ACCOUNT_BY_KEY_SPACE_ID
#define OFFER_ACCOUNT_BY_KEY_SPACE_ID 11
#endif

enum account_by_key_object_types
{
   key_lookup_object_type = ( OFFER_ACCOUNT_BY_KEY_SPACE_ID << 8 )
};
...
FC_REFLECT( offer::plugins::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( offer::plugins::account_by_key::key_lookup_object, offer::plugins::account_by_key::key_lookup_index )
