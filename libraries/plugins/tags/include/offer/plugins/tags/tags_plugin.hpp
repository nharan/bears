...
// time.
//
#ifndef OFFER_TAG_SPACE_ID
#define OFFER_TAG_SPACE_ID 5
#endif

#define OFFER_TAGS_PLUGIN_NAME "tags"
...
enum
{
   tag_object_type              = ( OFFER_TAG_SPACE_ID << 8 ),
   tag_stats_object_type        = ( OFFER_TAG_SPACE_ID << 8 ) + 1,
   peer_stats_object_type       = ( OFFER_TAG_SPACE_ID << 8 ) + 2,
   author_tag_stats_object_type = ( OFFER_TAG_SPACE_ID << 8 ) + 3
};
...
class tags_plugin : public plugin< tags_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = OFFER_TAGS_PLUGIN_NAME; return name; }
...
FC_REFLECT( offer::plugins::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( offer::plugins::tags::tag_object, offer::plugins::tags::tag_index )

FC_REFLECT( offer::plugins::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( offer::plugins::tags::tag_stats_object, offer::plugins::tags::tag_stats_index )

FC_REFLECT( offer::plugins::tags::comment_metadata, (tags) );

FC_REFLECT( offer::plugins::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( offer::plugins::tags::author_tag_stats_object, offer::plugins::tags::author_tag_stats_index )
