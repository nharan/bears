...
#ifndef OFFER_SMT_TEST_SPACE_ID
#define OFFER_SMT_TEST_SPACE_ID 13
#endif

enum smt_test_object_types
{
   smt_token_object_type = ( OFFER_SMT_TEST_SPACE_ID << 8 )
};
...
FC_REFLECT( offer::plugins::smt_test::smt_token_object,
   (id)
   (control_account)
   (decimal_places)
   (max_supply)
...
CHAINBASE_SET_INDEX_TYPE( offer::plugins::smt_test::smt_token_object, offer::plugins::smt_test::smt_token_index )
