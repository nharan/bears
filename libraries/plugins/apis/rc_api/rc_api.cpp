...
#include <offer/plugins/rc_api/rc_api.hpp>

#include <offer/plugins/rc/rc_objects.hpp>
#include <offer/plugins/rc/resource_sizes.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< offer::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( OFFER_RC_API_PLUGIN_NAME );
}
