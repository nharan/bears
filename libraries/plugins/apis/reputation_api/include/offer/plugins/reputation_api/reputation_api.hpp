...
struct account_reputation
{
   ...
   offer::protocol::share_type   reputation;
};
...
FC_REFLECT( offer::plugins::reputation::account_reputation,
            (account)(reputation) );

FC_REFLECT( offer::plugins::reputation::get_account_reputations_args,
            (account_lower_bound)(limit) );

FC_REFLECT( offer::plugins::reputation::get_account_reputations_return,
            (reputations) );
