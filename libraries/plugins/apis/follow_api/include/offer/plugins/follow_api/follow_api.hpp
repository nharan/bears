...
using offer::plugins::reputation::account_reputation;
...
FC_REFLECT( offer::plugins::follow::feed_entry,
            (author)(permlink)(reblog_by)(reblog_on)(entry_id) );

FC_REFLECT( offer::plugins::follow::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) );

FC_REFLECT( offer::plugins::follow::blog_entry,
            (author)(permlink)(blog)(reblog_on)(entry_id) );

FC_REFLECT( offer::plugins::follow::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) );

FC_REFLECT( offer::plugins::follow::api_follow_object,
            (follower)(following)(what) );

FC_REFLECT( offer::plugins::follow::reblog_count,
            (author)(count) );

FC_REFLECT( offer::plugins::follow::get_followers_args,
            (account)(start)(type)(limit) );

FC_REFLECT( offer::plugins::follow::get_followers_return,
            (followers) );

FC_REFLECT( offer::plugins::follow::get_following_return,
            (following) );

FC_REFLECT( offer::plugins::follow::get_follow_count_args,
            (account) );

FC_REFLECT( offer::plugins::follow::get_follow_count_return,
            (account)(follower_count)(following_count) );

FC_REFLECT( offer::plugins::follow::get_feed_entries_args,
            (account)(start_entry_id)(limit) );

FC_REFLECT( offer::plugins::follow::get_feed_entries_return,
            (feed) );

FC_REFLECT( offer::plugins::follow::get_feed_return,
            (feed) );

FC_REFLECT( offer::plugins::follow::get_blog_entries_return,
            (blog) );

FC_REFLECT( offer::plugins::follow::get_blog_return,
            (blog) );

FC_REFLECT( offer::plugins::follow::get_reblogged_by_args,
            (author)(permlink) );

FC_REFLECT( offer::plugins::follow::get_reblogged_by_return,
            (accounts) );

FC_REFLECT( offer::plugins::follow::get_blog_authors_args,
            (blog_account) );

FC_REFLECT( offer::plugins::follow::get_blog_authors_return,
            (blog_authors) );
