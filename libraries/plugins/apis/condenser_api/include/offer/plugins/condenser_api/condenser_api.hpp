...
#include <offer/plugins/account_history_api/account_history_api.hpp>
#include <offer/plugins/account_by_key_api/account_by_key_api.hpp>
...
#include <offer/plugins/market_history_api/market_history_api.hpp>
#include <offer/plugins/witness_api/witness_api.hpp>

#include <offer/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      reward_offer_balance( legacy_asset::from_asset( a.reward_offer_balance ) ),
      reward_coining_balance( legacy_asset::from_asset( a.reward_coining_balance ) ),
      reward_coining_offer( legacy_asset::from_asset( a.reward_coining_offer ) ),
   ...
   legacy_asset      reward_offer_balance;
   legacy_asset      reward_coining_balance;
   legacy_asset      reward_coining_offer;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             coining_balance;  /// convert coining_shares to coining offer
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_offer_dollars( c.percent_offer_dollars ),
   ...
   uint16_t          percent_offer_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      total_coining_fund_offer( legacy_asset::from_asset( o.total_coining_fund_offer ) ),
      total_coining_shares( legacy_asset::from_asset( o.total_coining_shares ) ),
      total_reward_fund_offer( legacy_asset::from_asset( o.total_reward_fund_offer ) ),
      ...
      pending_rewarded_coining_offer( legacy_asset::from_asset( o.pending_rewarded_coining_offer ) ),
   ...
   legacy_asset      total_coining_fund_offer;
   legacy_asset      total_coining_shares;
   legacy_asset      total_reward_fund_offer;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_coining_shares;
   legacy_asset      pending_rewarded_coining_offer;
...
struct api_witness_object
{
   ...
   time_point_sec          hardfork_time_vote = OFFER_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = OFFER_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = OFFER_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = OFFER_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = OFFER_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      offer_balance( legacy_asset::from_asset( e.offer_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), offer_revision( s_v ), fc_revision( fc_v ) {}
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      offer_volume( legacy_asset::from_asset( t.offer_volume ) ),
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      offer_volume( legacy_asset::from_asset( v.offer_volume ) ),
...
FC_REFLECT( offer::plugins::condenser_api::discussion_index,
...
FC_REFLECT( offer::plugins::condenser_api::api_account_object,
             ...
             (reward_bsd_balance)(reward_offer_balance)(reward_coining_balance)(reward_coining_offer)
...
FC_REFLECT_DERIVED( offer::plugins::condenser_api::extended_account, (offer::plugins::condenser_api::api_account_object),
...
FC_REFLECT( offer::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_offer_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( offer::plugins::condenser_api::extended_dynamic_global_properties,
            ...
            (total_coining_fund_offer)(total_coining_shares)
            (total_reward_fund_offer)(total_reward_shares2)(pending_rewarded_coining_shares)(pending_rewarded_coining_offer)
...
FC_REFLECT( offer::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( offer::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( offer::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( offer::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( offer::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bsd_balance)(offer_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( offer::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( offer::plugins::condenser_api::api_coining_delegation_object,
            (id)(delegator)(delegatee)(coining_shares)(min_delegation_time) )

FC_REFLECT( offer::plugins::condenser_api::api_coining_delegation_expiration_object,
            (id)(delegator)(coining_shares)(expiration) )

FC_REFLECT( offer::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( offer::plugins::condenser_api::discussion, (offer::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( offer::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( offer::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( offer::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( offer::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( offer::plugins::condenser_api::get_version_return,
            (blockchain_version)(offer_revision)(fc_revision) )

FC_REFLECT( offer::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( offer::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( offer::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( offer::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(offer_volume)(bsd_volume) )

FC_REFLECT( offer::plugins::condenser_api::volume,
            (offer_volume)(bsd_volume) )

FC_REFLECT( offer::plugins::condenser_api::order,
            (order_price)(real_price)(offer)(bsd)(created) )

FC_REFLECT( offer::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( offer::plugins::condenser_api::market_trade,
