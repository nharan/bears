...
namespace offer { namespace plugins { namespace condenser_api {
   ...
   struct api_chain_properties
   {
      ...
      operator legacy_chain_properties() const
      {
         ...
         props.account_creation_fee = legacy_offer_asset::from_asset( asset( account_creation_fee ) );
      ...
      int32_t        account_subsidy_budget = OFFER_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
      uint32_t       account_subsidy_decay = OFFER_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
   };
   ...
   struct legacy_comment_options_operation
   {
      ...
      legacy_comment_options_operation( const comment_options_operation& op ) :
         ...
         percent_offer_dollars( op.percent_offer_dollars ),
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_offer_dollars = percent_offer_dollars;
      ...
      uint16_t          percent_offer_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         offer_amount( legacy_asset::from_asset( op.offer_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
   ...
   struct legacy_pow2_operation
   {
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_offer_asset::from_asset( asset( props.account_creation_fee ) );
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_offer( legacy_asset::from_asset( op.reward_offer ) ),
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         ...
         offer_payout( legacy_asset::from_asset( op.offer_payout ) ),
...
void to_variant( const offer::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, offer::plugins::condenser_api::legacy_operation& );

void to_variant( const offer::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, offer::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const offer::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, offer::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( offer::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(bsd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
          )

FC_REFLECT( offer::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( offer::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( offer::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( offer::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( offer::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( offer::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( offer::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( offer::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( offer::plugins::condenser_api::legacy_transfer_to_coining_operation, (from)(to)(amount) )
FC_REFLECT( offer::plugins::condenser_api::legacy_withdraw_coining_operation, (account)(coining_shares) )
FC_REFLECT( offer::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( offer::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( offer::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( offer::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_offer_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( offer::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(bsd_amount)(offer_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( offer::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bsd_amount)(offer_amount) );
FC_REFLECT( offer::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( offer::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_offer)(reward_bsd)(reward_coins) )
FC_REFLECT( offer::plugins::condenser_api::legacy_delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
FC_REFLECT( offer::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(bsd_payout)(offer_payout)(coining_payout) )
FC_REFLECT( offer::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( offer::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( offer::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( offer::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( offer::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( offer::plugins::condenser_api::legacy_fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( offer::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( offer::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( offer::plugins::condenser_api::legacy_return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( offer::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(bsd_payout)(offer_payout)(coining_payout) )
FC_REFLECT( offer::plugins::condenser_api::legacy_producer_reward_operation, (producer)(coining_shares) )
FC_REFLECT( offer::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )

FC_REFLECT_TYPENAME( offer::plugins::condenser_api::legacy_operation )
