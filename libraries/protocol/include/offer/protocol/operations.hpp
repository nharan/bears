...
#include <offer/protocol/offer_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const offer::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  offer::protocol::operation& vo );
}*/

OFFER_DECLARE_OPERATION_TYPE( offer::protocol::operation )
FC_REFLECT_TYPENAME( offer::protocol::operation )
