...
#include <offer/protocol/fixed_string.hpp>
...
namespace offer {
   ...
   namespace protocol {
      ...
      #define OFFER_INIT_PUBLIC_KEY (offer::protocol::public_key_type(OFFER_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const offer::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  offer::protocol::public_key_type& vo );
    void to_variant( const offer::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, offer::protocol::extended_public_key_type& vo );
    void to_variant( const offer::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, offer::protocol::extended_private_key_type& vo );
}

FC_REFLECT( offer::protocol::public_key_type, (key_data) )
FC_REFLECT( offer::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( offer::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( offer::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( offer::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( offer::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( offer::protocol::share_type )

FC_REFLECT( offer::void_t, )
