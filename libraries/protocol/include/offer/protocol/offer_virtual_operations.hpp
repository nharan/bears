...
namespace offer { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), bsd_payout(s), offer_payout(st), coining_payout(v){}
   ...
   struct comment_benefactor_reward_operation : public virtual_operation
   {
      ...
      comment_benefactor_reward_operation( const account_name_type& b, const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         : benefactor( b ), author( a ), permlink( p ), bsd_payout( s ), offer_payout( st ), coining_payout( v ) {}
...
FC_REFLECT( offer::protocol::author_reward_operation, (author)(permlink)(bsd_payout)(offer_payout)(coining_payout) )
FC_REFLECT( offer::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( offer::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( offer::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( offer::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( offer::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( offer::protocol::fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( offer::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( offer::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( offer::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( offer::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( offer::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( offer::protocol::return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( offer::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(bsd_payout)(offer_payout)(coining_payout) )
FC_REFLECT( offer::protocol::producer_reward_operation, (producer)(coining_shares) )
FC_REFLECT( offer::protocol::clear_null_account_balance_operation, (total_cleared) )
