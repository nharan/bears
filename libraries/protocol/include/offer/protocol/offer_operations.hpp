...
namespace offer { namespace protocol {
   ...
   struct allowed_vote_assets
   {
      ...
      void validate() const
      {
         ...
         FC_ASSERT(is_allowed(OFFER_SYMBOL) == false,
            "OFFER can not be explicitly specified as one of allowed_vote_assets");
      }
    ...
    *  The percent_offer_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_offer_dollars  = OFFER_100_PERCENT; /// the percent of Offer Dollars to key, unkept amounts will be received as Offer Power
    ...
    * @ingroup operations
    *
    * @brief Transfers OFFER from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             offer_amount = asset( 0, OFFER_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      asset             offer_amount = asset( 0, OFFER_SYMBOL ); ///< the amount of offer to release
   ...
   /**
    *  This operation converts liquid token (OFFER or liquid SMT) into VFS (Coining Fund Shares,
   ...
   struct transfer_to_coining_operation : public base_operation
   {
      ...
      asset             amount;  ///< must be OFFER or liquid variant of SMT
    ...
    * coins to offer and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in OFFER, is converted into COINING SHARES for the new account. Accounts
       *  without coining shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_offer_asset account_creation_fee = legacy_offer_asset::from_amount( OFFER_MIN_ACCOUNT_CREATION_FEE );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = OFFER_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          bsd_interest_rate  = OFFER_DEFAULT_BSD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= OFFER_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= OFFER_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( bsd_interest_rate >= 0 );
         FC_ASSERT( bsd_interest_rate <= OFFER_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, OFFER_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between offer and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between OFFER and BSD,
    *  The funds are deposited after OFFER_CONVERSION_DELAY
    */
    ...
    * OFFER_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their coining offer.
    *
    * The result of the operation is to transfer the full COINING OFFER balance
...
FC_REFLECT( offer::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( offer::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( offer::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( offer::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( offer::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( offer::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( offer::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( offer::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( offer::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( offer::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( offer::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( offer::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( offer::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (bsd_interest_rate)
          )

FC_REFLECT_TYPENAME( offer::protocol::pow2_work )
FC_REFLECT( offer::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( offer::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( offer::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( offer::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( offer::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( offer::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( offer::protocol::transfer_to_coining_operation, (from)(to)(amount) )
FC_REFLECT( offer::protocol::withdraw_coining_operation, (account)(coining_shares) )
FC_REFLECT( offer::protocol::set_withdraw_coining_route_operation, (from_account)(to_account)(percent)(auto_coin) )
FC_REFLECT( offer::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( offer::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( offer::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( offer::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( offer::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( offer::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( offer::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( offer::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( offer::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( offer::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( offer::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( offer::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( offer::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( offer::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( offer::protocol::comment_payout_beneficiaries, (beneficiaries) )

#ifdef OFFER_ENABLE_SMT
FC_REFLECT( offer::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
FC_REFLECT( offer::protocol::allowed_vote_assets, (votable_assets) )
#endif

FC_REFLECT_TYPENAME( offer::protocol::comment_options_extension )
FC_REFLECT( offer::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_offer_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( offer::protocol::escrow_transfer_operation, (from)(to)(bsd_amount)(offer_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( offer::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( offer::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( offer::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bsd_amount)(offer_amount) );
FC_REFLECT( offer::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( offer::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( offer::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( offer::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( offer::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( offer::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( offer::protocol::claim_reward_balance_operation, (account)(reward_offer)(reward_bsd)(reward_coins) )
#ifdef OFFER_ENABLE_SMT
FC_REFLECT( offer::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
#endif
FC_REFLECT( offer::protocol::delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
