 ...
 * - Length is between (inclusive) OFFER_MIN_ACCOUNT_NAME_LENGTH and OFFER_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace offer::protocol


FC_REFLECT_TYPENAME( offer::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( offer::protocol::authority::key_authority_map)
FC_REFLECT( offer::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( offer::protocol::authority::classification, (owner)(active)(key)(posting) )
