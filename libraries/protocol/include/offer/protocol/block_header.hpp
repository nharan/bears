...
#include <offer/protocol/optional_automated_actions.hpp>
...
FC_REFLECT_TYPENAME( offer::protocol::block_header_extensions )

FC_REFLECT( offer::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( offer::protocol::signed_block_header, (offer::protocol::block_header), (witness_signature) )
