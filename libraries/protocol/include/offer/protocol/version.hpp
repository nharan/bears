...
/*
 * This class represents the basic versioning scheme of the Offer blockchain.
...
{
   class variant;
   void to_variant( const offer::protocol::version& v, variant& var );
   void from_variant( const variant& var, offer::protocol::version& v );

   void to_variant( const offer::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, offer::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( offer::protocol::version, (v_num) )
FC_REFLECT_DERIVED( offer::protocol::hardfork_version, (offer::protocol::version), )

FC_REFLECT( offer::protocol::hardfork_version_vote, (hf_version)(hf_time) )
