...
namespace offer { namespace protocol {
    ...
    public_key_type::public_key_type( const std::string& base58str )
    {
      ...
      //        to make public_key_type API more similar to address API
       std::string prefix( OFFER_ADDRESS_PREFIX );
    ...
    public_key_type::operator std::string() const
    {
       ...
       return OFFER_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = offer::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = offer::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = offer::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
