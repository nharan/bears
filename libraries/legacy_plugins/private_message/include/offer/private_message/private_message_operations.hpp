...
struct private_message_operation : public offer::protocol::base_operation
{
...
FC_REFLECT( offer::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

OFFER_DECLARE_OPERATION_TYPE( offer::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( offer::private_message::private_message_plugin_operation )
