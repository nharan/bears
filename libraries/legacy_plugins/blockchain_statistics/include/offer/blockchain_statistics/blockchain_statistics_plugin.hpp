...
// time.
//
#ifndef OFFER_BLOCKCHAIN_STATISTICS_SPACE_ID
#define OFFER_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef OFFER_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define OFFER_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif
...
{
   bucket_object_type = ( OFFER_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public offer::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return OFFER_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( offer::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( offer::blockchain_statistics::bucket_object, offer::blockchain_statistics::bucket_index )
