...
int main( int argc, char** argv, char** envp )
{
   ...
   schemas.push_back( get_schema_for_type< offer::chain::account_object >() );
   schemas.push_back( get_schema_for_type< offer::chain::comment_object >() );
