...
#include <offer/schema/schema_types.hpp>

#include <offer/chain/schema_types/oid.hpp>
#include <offer/protocol/schema_types/account_name_type.hpp>
#include <offer/protocol/schema_types/asset_symbol_type.hpp>
...
using offer::schema::abstract_schema;
...
FC_REFLECT( offer_schema, (schema_map)(chain_object_types) )

int main( int argc, char** argv, char** envp )
{
   offer::chain::database db;
   offer::chain::database::open_args db_args;
   ...
   db.for_each_index_extension< offer::chain::index_info >(
      [&]( std::shared_ptr< offer::chain::index_info > info )
      {
         std::string name;
