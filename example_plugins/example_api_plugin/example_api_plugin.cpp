...
#define OFFER_EXAMPLE_API_PLUGIN_NAME "example_api"

namespace offer { namespace example_api_plugin {
   ...
   class example_api_plugin : public appbase::plugin< example_api_plugin >
   {
      public:
         ...
         static const std::string& name() { static std::string name = OFFER_EXAMPLE_API_PLUGIN_NAME; return name; }
...
} } // offer::example_api_plugin

// Args and return types need to be reflected. hello_world_args does not because it is a typedef of a reflected type
FC_REFLECT( offer::example_api_plugin::hello_world_return, (message) )
FC_REFLECT( offer::example_api_plugin::echo_args, (call) )
FC_REFLECT( offer::example_api_plugin::echo_return, (response) )
