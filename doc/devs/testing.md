...
operation_tests      // Unit Tests of Offer operations
operation_time_tests // Tests of Offer operations that include a time based component (ex. coining withdrawals)
...
```
cmake -D BUILD_OFFER_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
