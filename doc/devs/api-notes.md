...
The Offer developers recommend using the first of these methods to secure the API by binding to localhost, as follows:
...
The `offerd` process includes username/password based authentication to individual API's.
